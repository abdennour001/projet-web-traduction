    ...
    <div class="col-8 offset-2">
        <form id="signUpForm" method="post" action="<?php echo url('/sign-up/signing')?>">
            ...
            <div class="form-group">
                ...
                <input value="<?php echo old('fax') ?>" type="number" minlength="5" class="form-control" id="fax" name="fax" placeholder="Numéro fax">
            </div>

            <div class="form-group">
                <label for="wilaya">Wilaya</label>
                <input value="<?php echo old('wilaya') ?>" type="text" class="form-control" id="wilaya" name="wilaya" placeholder="Entrer Wilaya">
            </div>

            <div class="form-group">
                <label for="adresse">Commune</label>
                <input value="<?php echo old('commune') ?>" type="text" class="form-control" id="commune" name="commune" placeholder="Entrer Commune">
            </div>
