<div class="text-black-50 my-5 text-center">
    <h1>Actualité</h1>
</div>
<div class="container text-left">
    <div class="card" data-toggle="modal" data-target=".bd-example-modal-xl">
        ...
        <div class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted">20-01-2020</h6>
            <p class="card-text">
                Dans l’histoire de la Bible en Europe, ce sont les traductions en latin qui ont joué un rôle prépondérant. Au 4e siècle, on disposait déjà de diverses traductions en vieux latin.
            </p>
            <a href="article?title=Histoire de traduction&body=Pour les Juifs déjà, le principe d’une traduction était acquis. Que l’on songe à la version grecque des Septante, traduction de l’Ancien Testament hébreu entreprise au 3e siècle et terminée au 2e siècle av. J.-C. à Alexandrie, qui reste le texte officiel de l’Eglise orthodoxe grecque. Les auteurs néotestamentaires eux-mêmes l’ont souvent citée dans leurs écrits et n’ont pas systématiquement cherché à reproduire une traduction littérale de l’hébreu.
...
<div class="container mt-3 text-left">
    <div class="card" data-toggle="modal" data-target=".bd-example-modal-xl">
        ...
        <div class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted">06-01-2020</h6>
            <p class="card-text">
            ...
            <a href="article?title=Les traductions modernes&body=Les traductions françaises des 20e et 21e siècles peuvent se classer en deux catégories principales:
les versions à correspondance formelle (parfois appelées littérales)
les versions à équivalence dynamique ou fonctionnelle
Il est possible de trouver des versets traduits de manière littérale dans une version dynamique, ou l’inverse. Si l’on veut vraiment bien comprendre le sens d’un passage, et dans la mesure où l’on ne connaît pas les langues bibliques, il peut être important de le lire dans au moins deux versions différentes, si possible adoptant des principes de traduction différents.&date=06-01-2020" class="btn btn-secondary card-link">Lire la suite</a>
        </div>
    </div>
</div>
<div class="container mt-3 text-left">
    <div class="card" data-toggle="modal" data-target=".bd-example-modal-xl">
        <img src="https://www.migaltranslations.com/sites/default/files/translation.jpg" alt="Image cap"
             class="card-img-top">
        <div class="card-body">
            <h5 class="card-title">Les premières traductions françaises</h5>
            <h6 class="card-subtitle mb-2 text-muted">10-01-2020</h6>
            <p class="card-text">
            ...
            <a href="article?title=Les premières traductions françaises&body=En français, les premières traductions ont été effectuées à partir de la traduction latine officielle, la Vulgate de Jérôme, et ce sont les protestants qui ont, les premiers, proposé une version basée sur les langues originales, l’hébreu et le grec.
...
1894 	Bible française de l’abbé Crampon, première version catholique sur la base des textes grec et hébreu.&date=10-01-2020" class="btn btn-secondary card-link">Lire la suite</a>
        </div>
    </div>
</div>
...
<script>
    ...
    console.log("Hello from actualite.")
