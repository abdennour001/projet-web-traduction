<div class="row">
    <div class="col-8 offset-2">
        <form id="modifierClientForm" method="post" action="<?php echo url('/edit-client/editing')?>">
            ...
            <a href="<?php echo url('/client')?>" class="btn btn-secondary card-link mt-3 ml-3">Annuler</a>
        </form>
    </div>
</div>
